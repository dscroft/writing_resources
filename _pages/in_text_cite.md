...
Importantly portion of the citation in brackets is not a grammatical object. This means that it does not form part of the sentence. 
Your sentences have to make sense and be grammatically correct even if everything in brackets is removed.
...
- Grammatically the sentence as written is "and team has a prominent paper.", which has multiple issues.
  - First letter is not capitalised.
  - Doesn't make sense.

The sentence should have been “Smith et al. (2022) and team has a prominent paper.”.
